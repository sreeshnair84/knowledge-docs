...
| Character | Role |
| ----------- | ------ |
| **Rosalind Achterberg** ⭐ | Enterprise AI Architect, Security Platform (EA) — our protagonist |
| **Desmond Okafor** | CISO — sponsor |
...
*The most obvious version of this system is rejected before it is ever formally proposed*
`Weeks 1–5 | January 2027`
...
*Attendees: Desmond Okafor (CISO), Rosalind Achterberg (EA)*
:::
...
*Attendees: Rosalind Achterberg (EA), Corinne Blake (IAM Lead)*
:::
...
*Attendees: Rosalind Achterberg (EA), Desmond Okafor (CISO)*
:::
...
*A rejection on observability grounds nobody had prepared for*
`Weeks 6–10 | February 2027`
...
*Attendees: Rosalind (EA), Desmond (CISO), Corinne (IAM), Hank Osei (SRE Lead), Petra Lindqvist (SOC Director)*
:::
...
*Two separate adversarial findings land in the same exercise, for very different reasons*
`Weeks 12–20 | March–April 2027`

:::note[📅 Meeting]
**🕐 11:00**  📍 *Tuesday 16 March 2027 | Red Team lab*

**Adversarial Exercise Findings Review**

*Attendees: Rosalind (EA), Tamsin Reyes (Red Team Lead), Yusuf Demir (Lead AI Eng)*
:::
...
*A real production incident during hardening, and an unexpected vendor pricing change that forces a re-architecture*
`Weeks 22–30 | May–July 2027`
...
*Attendees: Rosalind Achterberg (EA), Yusuf Demir (Lead AI Eng), Hank Osei (SRE), on-call analyst*
:::
...
*Attendees: Rosalind (EA), Yusuf (Lead AI Eng), Corinne Blake (IAM)*
:::
...
*Production validation, not a drill*
`Months 1–6 | August 2027–January 2028`
...
*Attendees: Petra Lindqvist (SOC Director), overnight analyst*
:::
...
*Attendees: Rosalind (EA), Petra Lindqvist (SOC Director), Corinne Blake (IAM)*
:::
...
*Strong results invite exactly the proposal the programme was designed to resist*
`Month 8 | March 2028`
...
*Attendees: Rosalind (EA), Desmond Okafor (CISO), Petra Lindqvist (SOC Director), Corinne Blake (IAM)*
:::
...
*A candid look back at what nearly went wrong, and what it taught the whole platform*
`Month 8 | March 2028`
...
*Attendees: Rosalind (EA), Yusuf Demir (Lead AI Eng), Hank Osei (SRE), Tamsin Reyes (Red Team)*
:::
