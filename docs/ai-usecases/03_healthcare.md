...
2. Discovery Transcript 5.1 Kickoff — Week 1 5.2 Clinician Shadowing — Week 2

- 5.3 Utilization Management Shadowing — Week 3 5.4 Capability Mapping and ROI — Week 4

- 1. Architecture Workshops 6.1 Data & Information Architecture 6.2 AI/Platform Architecture — Whiteboard Session, Week 9 6.3 Security & Identity Architecture
