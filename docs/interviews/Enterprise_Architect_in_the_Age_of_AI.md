...
1. [The Evolving Identity of the Enterprise Architect](#1-the-evolving-identity)
2. [Core Domains of Responsibility](#2-core-domains)
3. [AI Strategy & Governance](#3-ai-strategy--governance)
4. [Agent Architecture & Orchestration](#4-agent-architecture--orchestration)
5. [Code Copilot & Developer Experience Architecture](#5-code-copilot--developer-experience)
6. [Workflow Automation Architecture](#6-workflow-automation-architecture)
7. [Data Architecture in an AI-First World](#7-data-architecture)
8. [Security, Risk & Trust Architecture](#8-security-risk--trust)
...
14. [The EA Maturity Progression](#14-maturity-progression)
