...
| --- | --- | --- |
| Diaphragmatic Breathing | 5 min | Belly breathing: inhale 4 counts, hold 4, exhale 8. Hand on belly only. |
| Vocal Warm-Up | 5 min | Lip trills, humming scales, jaw loosening. NEVER skip this. |
...
| --- | --- | --- | --- | --- |
| Day 1 | Breathing Baseline | Diaphragmatic breathing 3x sets | Yoodli recording | Feel belly breathing |
| Day 2 | Articulation | Tongue twisters x5 slowly | YouTube: Toastmasters | Clear consonants |
| Day 3 | Recording | Read 1 paragraph, record & review | Yoodli | Spot filler words |
| Day 4 | Breathing + Warm-up | Full 25-min daily routine | Box breathing guide | Complete full routine |
| Day 5 | Identify Habits | Review 3 recordings for patterns | Yoodli analytics | List top 3 bad habits |
...
| Day | Focus | Exercise | Resource | Goal |
| --- | --- | --- | --- | --- |
| Day 8 | Breath Control | Count to 20 on one breath | Breathing diagram | Reach count of 15+ |
| Day 9 | Articulation + Record | Twisters → record a paragraph | Yoodli | Reduce fillers by 1 |
| Day 10 | Warm-up Focus | Humming scales + jaw exercises | Toastmasters YouTube | Smooth warm-up flow |
| Day 11 | Watch & Study | Watch 1 TED Talk, note techniques | TED-Ed YouTube | List 3 things to copy |
| Day 12 | Mimic Exercise | Re-deliver 1 min from TED Talk | Yoodli recording | Match speaker energy |
...
| Day | Focus | Exercise | Resource | Goal |
| --- | --- | --- | --- | --- |
| Day 15 | Pace Control | Read slowly — 20% below natural speed | Record + Yoodli | Feel comfortable slow |
| Day 16 | Pause Practice | Insert 2-sec pause after each sentence | Mirror practice | 5 pauses without panic |
| Day 17 | Pitch Variation | Read script in exaggerated emotional style | Yoodli recording | Break monotone habit |
| Day 18 | Volume Dynamics | Loud → soft → loud in one sentence | Record & review | Noticeable contrast |
| Day 19 | Breathing + Delivery | Full routine + 5-min delivery practice | Toastmasters YouTube | Combine skills |
...
| Day | Focus | Exercise | Resource | Goal |
| --- | --- | --- | --- | --- |
| Day 22 | Storytelling | Tell a 2-min personal story with structure | Yoodli recording | Clear beginning/end |
| Day 23 | Audience Simulation | Deliver to mirror as if real audience | Mirror + timer | No looking away |
| Day 24 | Toastmasters Visit | Attend a Toastmasters meeting (guest) | Toastmasters.org | Get live experience |
| Day 25 | Power Words | Practice impactful phrases & strong verbs | TED-Ed study | Replace weak language |
| Day 26 | Full Performance | Deliver a 3-min speech on any topic | Yoodli full recording | All skills combined |
...
Exhale slowly for 8 counts — belly falls back in
