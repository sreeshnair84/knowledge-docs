...
1. Tamper-evident audit logging — every allow, deny, and policy mutation is logged with cryptographic integrity protection, providing the immutable record required for incident response and the audit requirements specified throughout Domain 4.
