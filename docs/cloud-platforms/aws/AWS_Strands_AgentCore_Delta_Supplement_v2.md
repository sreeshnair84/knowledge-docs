...
I **Storing full conversation transcripts in episodic memory** : Episodic memory is designed for *extracted insights* — not raw transcripts. Raw transcripts consume excessive memory, increase retrieval latency, and create PII exposure risk.
