...
2. [Team Structure, RACI & Responsibility Mappings](#team-structure-raci--responsibility-mappings)
   ...
   - [Responsibility Assignment Matrix](#responsibility-assignment-matrix--stakeholder-map)
3. [AI-DLC: Methodology, Phases & EA Impacts](#ai-dlc-methodology-phases--ea-impacts)
4. [Preliminary Phase — Foundation](#preliminary-phase--foundation)
5. [Architecture Vision (Phase A)](#architecture-vision)
6. [Business Architecture (Phase B)](#business-architecture)
7. [Information Systems Architecture (Phase C)](#information-systems-architecture)
8. [Technology Architecture (Phase D)](#technology-architecture)
9. [Delivery, Governance & Change (Phases E–H)](#opportunities-migration-governance--change)
10. [Requirements Management](#requirements-management--continuous)
...
**CNCF**and its hosted project names are trademarks of the Linux Foundation. This document is CONFIDENTIAL and the property of GlobalCorp Enterprises Enterprise Architecture. © 2026 GlobalCorp Enterprises. All rights reserved.