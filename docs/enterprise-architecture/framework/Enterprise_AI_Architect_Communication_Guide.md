...
|**03**|**Arena 1: Executive & CXO Communication**|Strategy Layer|
|**04**|**Arena 2: Product & Domain Stakeholders**|Discovery Layer|
|**05**|**Arena 3: Engineering & Architecture**|Execution Layer|
|**06**|**Arena 4: Governance, Risk & Operations**|Assurance Layer|
|**07**|**The Listening Deficit — A Critical Gap**|Meta-Skill|
|**08**|**Communication Toolkit & Templates**|Artifacts|
|**09**|**90-Day Structured Action Plan**|Implementation|
|**10**|**Weekly & Monthly Practice Cadence**|Habits|
|**11**|**Self-Assessment Rubric**|Measurement|
|**12**|**Staying Market-Relevant**|Continuous Growth|
...
- Repeatable patterns signal maturity — they show you've solved the problem before. 

- Stakeholders remember structure, not content. Give them a frame they can repeat. 
...
The framework is built on a simple insight: the same AI architecture decision must be communicated in four completely different ways depending on the room you're in. Attempting to use a single communication style across all four arenas is the most common reason technically excellent architects fail to achieve principal-level influence. 

|**Ar**<br>**en**<br>**a**|**Name**|**Primary Objective**|**Key Question Answered**|
|---|---|---|---|
|1|Executive / CXO|Translate AI strategy into business value &<br>investment choices|Why should we fund this?|
|2|Product /<br>Domain|Bridge business problems and AI solutions without<br>overwhelming|What will the AI actually do for us?|
...
- In most orgs, whoever communicates AI governance clearly becomes the default 'principal voice' on AI. 

- Whoever controls the narrative controls the investment decisions. 
...
|**01**|**Problem**|What business problem or market shift demands attention?|
|---|---|---|
|**02**|**Impact Today**|What is the cost of inaction in financial or competitive terms?|
|**03**|**AI Opportunity**|Where does AI create a specific, measurable advantage?|
|**04**|**Options**|What are 2–3 paths forward, with trade-offs stated plainly?|
...
|---|---|
|LLM / embedding / RAG|AI capability / intelligent search / knowledge retrieval|
|Vector store|Semantic knowledge base|
|Hallucination risk|Response accuracy risk / AI reliability controls|
|Model fine-tuning|Domain specialisation investment|

|Agentic system|Autonomous AI workflow / AI-driven process<br>automation|
|---|---|
|MLOps / DevOps|AI operating model / AI delivery pipeline|
...
**1. Business Objective** — What outcome is the business trying to achieve? 

**2. Current Workflow** — Walk me through how this is done today, step by step. 

**3. Pain Points & Constraints** — Where does the current process break down? 

**4. Data Reality** — What data exists, where does it live, how clean is it? 

**5. Decision & Action Points** — Where are decisions made? Who makes them? 
...
|---|---|---|
|Business Problem|One-sentence problem statement with a<br>measurable baseline|Aligns on what success looks like|
|Success Metric|Primary KPI and how it will be measured|Prevents scope creep post-launch|
|Users / Personas|Who interacts with the AI and in what context|Shapes UX and trust requirements|
|Current Process|Step-by-step workflow before AI|Reveals integration complexity|
|AI Interaction|Prompts, decisions, actions the AI will take|Makes scope concrete|
|Data Sources|Systems, files, APIs the AI will access|Reveals data readiness gaps|
|Risks / Failure Modes|What happens when the AI is wrong|Forces proactive guardrail design|
|What AI Will NOT Do|Explicit exclusions from AI scope|Manages stakeholder expectations|
...
- Always define aspirational behaviour (what might come in later iterations). 

- Always state 3+ explicit exclusions: 'This AI will NOT make final decisions on...' 

- Review exclusions with stakeholders and get verbal confirmation in the meeting. 
...
|**1**|**Context View**|Actors, external systems, high-level data flows. Answer: What is this<br>system and what does it touch?|
|---|---|---|
|**2**|**Capability View**|Agentic stack layers: engagement, capabilities, data, governance.<br>Answer: What can this system do and how is it structured?|
...
|**Decision Axis**|**Option A**|**Option B**|**Key NFR Driver**|
|---|---|---|---|
|Build vs Buy|Custom development|Vendor platform|Control vs Speed|
|Deployment|Centralised platform|Federated per-domain|Governance vs Autonomy|
|Processing|Online / real-time|Batch / async|Latency vs Cost|
...
- Define 'definition of ready' for AI features: data readiness, evaluation criteria, guardrails. 

- Define 'definition of done' for AI features: performance benchmarks, safety checks, monitoring. 

- Frame architectural work as enablers that unlock future feature capacity. 
...
|**Policy Requirement**|_What does the policy or regulation_<br>_require?_|e.g. "The model must not generate<br>content that..."|
|---|---|---|
|**Architecture Control**|_What technical mechanism enforces it?_|e.g. "Output filtering layer with pattern<br>matching and..."|
|**Runtime Check**|_How is compliance verified in_<br>_production?_|e.g. "Each response is scored by a<br>safety classifier before..."|
|**Escalation Path**|_What happens when the control fails or_<br>_triggers?_|e.g. "Alert fires to on-call ML engineer;<br>response is blocked and..."|
...
|**Feedback Loop**|**What is Measured**|**Cadence**|**Owner**|
|---|---|---|---|
|Data Quality|Completeness, freshness, drift from<br>baseline|Daily|Data Engineering|
|Model Performance|Accuracy, latency, cost per query,<br>degradation|Weekly|ML Platform|
|Safety / Guardrails|Blocked outputs, false positive rate, edge<br>cases|Daily|AI Safety|
|Business Outcome|KPI movement vs baseline, user adoption|Monthly|Product Owner|
...
- Runbooks: Document model-specific failure modes and remediation steps separately from app runbooks. 

- L2/L3 Demarcation: Clearly separate application incidents (infrastructure) from model/data incidents (ML). 

- Capacity Planning: Model inference costs scale differently from compute — quantify token budgets. 
...
|**Readiness**<br>**Dimension**|**Key Questions to Ask**|**Red Flags**|
|---|---|---|
|Data Maturity|Where does the relevant data live? How is it<br>accessed? When was it last validated?|No data owner identified; data in flat<br>files; no access controls|
|Organisational Change|Who will change their workflow because of this?<br>Have they been consulted?|No change management plan; 'build<br>it and they'll come' mindset|
|Governance Appetite|Who owns the AI decision? What approval is<br>needed for production deployment?|No AI policy exists; legal/compliance<br>not engaged; no escalation path|
...
- Silence as a tool: After asking a question, count to 5 before speaking. Stakeholders fill silence with truth. 

- Reflect back: Summarise what you heard before moving on — it builds trust and catches misalignment early. 
...
|**A1**|**Executive One-Pager**<br>Arena 1|1 page covering: AI opportunity, options, recommended path, 90-day<br>ask, and financial/risk context. Refreshed quarterly or before any<br>steering event.|
|---|---|---|
|**A2**|**AI Use Case Sheet**<br>Arena 2|1 page per use case covering the 10-field template from Arena 2.<br>Produced at the start of every product discovery engagement.|
...
|**Slide 1**|**Value**|AI opportunity mapped to business capabilities and financial levers|
|---|---|---|
|**Slide 2**|**Capabilities**|What AI capabilities you're building, buying, or partnering for|
|**Slide 3**|**Roadmap**|Phased timeline: Platform→Pilots→Scale→Optimise|
...
I Audit your last 3 stakeholder communications — which arena did they belong to? Did you use the right register? 

I Identify 1 active initiative to use as your practice case for the full 90 days. 

I Produce your first draft of the 4-view architecture narrative for that initiative. 

I Schedule 3 conversations with stakeholders from different arenas using the initiative as context. 
...
I Present the Executive One-Pager to at least one senior business stakeholder — not technical. 

I Run a discovery conversation using the Arena 2 flow with a product owner. 

- I Present the 4-view architecture narrative to an engineering audience. 

I Facilitate a governance/risk discussion using the control chain pattern. 

I Collect explicit feedback after each conversation: 'Was this clear? What was missing?' 
...
I Identify a second initiative and produce all four artifacts independently, in under 2 hours. 

- I Build your quarterly refresh cadence: which artifacts get updated when? 

- I Teach one junior architect your Arena 3 communication pattern — teaching reveals gaps. 

- I Benchmark yourself against the self-assessment rubric again and measure delta. 

- I Set your next 90-day focus based on remaining gaps. 
...
|**Day**|**Practice**|**Time**|
|---|---|---|
|Monday|Pick one active initiative. Write a 3-sentence exec summary using the storyline<br>structure.|10 min|
...
- Produce or refresh one of the four core artifacts using a current initiative. 

- Conduct one readiness assessment conversation with a new stakeholder using the Arena 2 diagnostic flow. 
...
- Refresh the 'AI Governance in One Page' risk view. 

- Rehearse both as if explaining to a non-technical COO — record yourself and watch it back. 

- Update your vocabulary shift table based on terms you've encountered in the quarter. 
...
- Teach to learn: explaining your patterns to a junior architect surfaces gaps faster than solo review. 
...
Rate yourself on each dimension from 1 (Developing) to 4 (Distinguished). Be conservative — stakeholder perception matters more than your own assessment. If possible, ask a trusted colleague to rate you independently and compare. 

|**Dimension**|**1 — Developing**|**2 — Practising**|**3 — Proficient**|**4 — Distinguished**|
|---|---|---|---|---|
|**Exec Storyline**|Leads with tech|Some business<br>framing|Consistent business<br>frame|Shapes exec decisions<br>through narrative|
|**Business**<br>**Vocabulary**|Uses tech jargon|Translates when<br>prompted|Always business<br>language|Teaches others to<br>translate|
|**Use Case Sheets**|Ad hoc<br>documentation|Inconsistent<br>template use|Consistent template<br>every time|Template becomes team<br>standard|
|**Discovery Listening**|Presents solution<br>first|Asks some<br>questions|Systematic diagnostic<br>flow|Uncovers unstated<br>constraints routinely|
|**4-View Narrative**|Single-view<br>presentations|2 views<br>inconsistently|Full 4-view for major<br>work|Adapts views to audience<br>on the fly|
|**Trade-off Framing**|Single<br>recommendation|2 options<br>sometimes|3 options with NFR<br>anchoring|Facilitates team trade-off<br>decisions|
|**Governance Pattern**|Risk as afterthought|Lists risks reactively|Policy→Control→Check<br>→Escalation|Owns governance<br>narrative for org|
|**Feedback Loops**|Not discussed|Mentioned<br>informally|Named loops with<br>owners|Feedback loops in every<br>architecture|
...
|---|---|---|
|**18–25**|**Developing**<br>**Competence**|You have some patterns working. Pick the 2 lowest dimensions<br>and go deep.|
|**26–33**|**Practising**<br>**Systematically**|Good foundation. Now focus on consistency and teaching others.|

**Principal-Level Maturity** 

**34–40** 

Your patterns are robust. Focus on scaling your approach to your team. 
...
- Monthly: Scan 3–5 principal architect / head of AI JDs. Extract new vocabulary, competency language, and emerging themes. 

- Quarterly: Update your personal communication rubric to reflect new expectations. 
...
_Key references: TOGAF, Archimate, Business Capability Modeling_ 
...
_Key references: LangChain, CrewAI, AutoGen patterns; vendor architecture guides_ 
...
_Key references: EU AI Act, NIST AI RMF, ISO 42001_ 
...
_Key references: Prompt patterns for architecture communication_ 
