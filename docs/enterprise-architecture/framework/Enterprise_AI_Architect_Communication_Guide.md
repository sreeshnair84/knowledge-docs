...
|**Policy Requirement**|*What does the policy or regulation*<br>*require?*|e.g. "The model must not generate<br>content that..."|
|---|---|---|
|**Architecture Control**|*What technical mechanism enforces it?*|e.g. "Output filtering layer with pattern<br>matching and..."|
