...
source_file: ""
tags: ["enterprise-architecture", "arb"]
---

# Architectural Review Board (ARB)

A comprehensive reference for running AI-native Architectural Review Boards — covering governance models, economic evaluation, knowledge management, artifact standards, and industry case studies.
