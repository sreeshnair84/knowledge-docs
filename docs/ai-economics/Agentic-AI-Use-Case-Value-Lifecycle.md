...
*Figure 1. Core value-lever metrics, today vs. steady-state target (Year 3).*
...
*Figure 2. Steady-state annual value by driver.*
...
*Figure 3. Value realized vs. cost, by year, with cumulative net value.*
