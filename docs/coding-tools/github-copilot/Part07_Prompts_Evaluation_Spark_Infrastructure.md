...
I _These are GitHub's own headline scale figures and represent the most reliable, directly verifiable infrastructure-load evidence available for this report; they say nothing directly about GPU scheduling, multi-region failover design, or request-batching internals, which GitHub has not published in comparable technical detail._ 
...
I _A report that fabricated specific GPU scheduling algorithms or batching window sizes for GitHub's infrastructure, in the absence of any public source, would be presenting invented detail as fact. This report instead documents the boundary of public knowledge explicitly._ 
