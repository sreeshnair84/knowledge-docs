...
- 61%  `coding-tools/github-copilot/Part01_Vision_Copilot_Architecture_RepoIntelligence` <-> `coding-tools/github-copilot/Part04_RAG_Agents_Models_Platform`
...
- 61%  `coding-tools/github-copilot/Part07_Prompts_Evaluation_Spark_Infrastructure` <-> `coding-tools/github-copilot/Part13_CICD_Observability_Scaling`
